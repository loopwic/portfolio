  ...
  >
    <div className="mx-auto w-full max-w-[896px]">
      ...
      <div className="relative mt-9 max-w-3xl">
        ...
        <span
          aria-hidden="true"
          className="absolute top-0 bottom-0 left-0 w-px origin-top bg-foreground/70"
        ...
        <ol>
          {PROFILE.works.map((work, index) => (
            ...
            >
              <span
                aria-hidden="true"
                className="timeline-dot absolute top-1.5 -left-[5px] size-[9px] rounded-full border border-background bg-foreground shadow-[0_0_0_4px_var(--background)]"
              />
              <p className="font-mono text-xs text-foreground/62">
                {work.period}
              </p>
              <div className="timeline-copy mt-2 md:mt-0">
