...
<Head>
  <title>从零开始配置 Alacritty</title>
  <meta name="description" content="在macos上配置 Alacritty." />
  <meta name="keywords" content="alacritty, terminal, configuration" />
  <meta name="author" content="Loopwic" />
  <meta property="og:title" content="从零开始配置 Alacritty" />
</Head>
